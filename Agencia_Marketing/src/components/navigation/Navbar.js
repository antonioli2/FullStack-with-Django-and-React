...
import loadingdots from '../../assets/img/loading-dots.gif'
import logo from '../../assets/img/logofondotransparente.png'
    ...
    return(
        <nav className='w-full py-4 top-0 fixed'>
            ...
            <div className="-ml-4 -mt-2 flex flex-wrap items-center justify-between sm:flex-nowrap md:px-14 px-2">
                ...
                <button
                    type="button"
                    className="ml-12 relative inline-flex items-center rounded-md border border-transparent bg-grey-button px-6 py-2 text-lg font-bold text-white shadow-sm transition duration-300 ease-in-out hover:bg-black focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
                >
                    Hire us
                    <img src={loadingdots} className='w-12 h-4 mt-1 ml-2'/>
                </button>
                </div>
            </div>
            </div>
